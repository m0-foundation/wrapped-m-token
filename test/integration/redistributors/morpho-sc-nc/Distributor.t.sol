...
import { Distributor } from "../../../../src/redistributors/morpho-sc-nc/Distributor.sol";
...
contract DistributorTests is TestBase {
    ...
    function test_equalSharePrices() external {
        ...
        assertEq(_distributor.getClaimable(_accounts[0]), _claimable[0][0] += (40 * _morphoYield) / 105);
        assertEq(_distributor.getClaimable(_accounts[1]), _claimable[1][1] += (30 * _morphoYield) / 105);
        ...
        assertEq(_distributor.getClaimable(_accounts[0]), _claimable[0][0] += (30 * _morphoYield) / 87 - 1);
        assertEq(_distributor.getClaimable(_accounts[1]), _claimable[1][1] += (24 * _morphoYield) / 87 - 1);
        ...
        assertEq(_distributor.getClaimable(_accounts[4]), _claimable[2][4] += (3 * _morphoYield) / 87 - 1);
        assertEq(_distributor.getClaimable(_accounts[5]), _claimable[2][5] += (5 * _morphoYield) / 87);
