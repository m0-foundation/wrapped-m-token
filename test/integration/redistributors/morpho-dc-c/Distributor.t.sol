...
import { Distributor } from "../../../../src/redistributors/morpho-dc-c/Distributor.sol";
...
contract DistributorTests is TestBase {
    ...
    function test_equalSharePrices() external {
        ...
        assertEq(_distributor.getClaimable(_vaults[2], _accounts[3]), _claimable[2][3] += (5 * _morphoYield) / 75 - 1);
        assertEq(_distributor.getClaimable(_vaults[2], _accounts[4]), _claimable[2][4] += (5 * _morphoYield) / 75 - 1);
        assertEq(_distributor.getClaimable(_vaults[2], _accounts[5]), _claimable[2][5] += (5 * _morphoYield) / 75 - 1);
        ...
        assertEq(
            ...
            _claimable[0][0] += (40 * _morphoYield) / 105 + 1
        );
        ...
        assertEq(_distributor.getClaimable(_vaults[0], _accounts[0]), _claimable[0][0] += (30 * _morphoYield) / 87);
        ...
        assertEq(_distributor.getClaimable(_vaults[2], _accounts[3]), _claimable[2][3] += (15 * _morphoYield) / 87);
        assertEq(_distributor.getClaimable(_vaults[2], _accounts[4]), _claimable[2][4] += (3 * _morphoYield) / 87);
        assertEq(_distributor.getClaimable(_vaults[2], _accounts[5]), _claimable[2][5] += (5 * _morphoYield) / 87 + 1);
