...
import { VaultFundsDistribution } from "../../../src/redistributors/morpho/VaultFundsDistribution.sol";
...
contract Distributor is VaultFundsDistribution {
    ...
    function setShares(uint256 distributable_, address vault_, uint256 amount_) external {
        _setShares(distributable_, vault_, amount_);
    }
...
contract WrappedMTokenTests is Test {
    ...
    function test_basic() external {
        ...
        _distributor.setShares(0, _vault0, 1_000);

        assertEq(_distributor.getCumulativeDistribution(_vault0), 0);

        /* ============ Vault0 Adds 1000 Shares ============ */

        _distributor.setShares(0, _vault0, 2_000);
        ...
        _distributor.setShares(0, _vault1, 1_000);
        ...
        _distributor.setShares(0, _vault2, 500);
        ...
        _distributor.setShares(100, _vault1, 0);
