...
contract WrappedMTokenTests is Test {
    ...
    function setUp() external {
        ...
        _earnerStatusManager = new MockEarnerStatusManager();
        _implementation = new WrappedMTokenHarness(address(_mToken), _migrationAdmin, address(_earnerStatusManager));
    ...
    function test_enableEarning_earningCannotBeReenabled() external {
        ...
        _earnerStatusManager.setStatusFor(address(_wrappedMToken), false);
