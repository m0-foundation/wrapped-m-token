...
contract Tests is Test {
    ...
    function test_story() external {
        ...
        vm.prank(_alice);
        uint256 yield_ = _wrappedM.claim(_alice);
        ...
        // Assert Globals
        assertEq(_wrappedM.totalEarningSupply(), 450_000000);
        assertEq(_wrappedM.totalNonEarningSupply(), 200_000000);
        assertEq(_wrappedM.totalSupply(), 500_000000);
        // assertEq(_wrappedM.accruedYieldOfEarningSupply(), 150_000000);
        assertEq(_wrappedM.excessOfM(), 250_000000);
        ...
        // Assert Globals
        assertEq(_wrappedM.totalEarningSupply(), 350_000001);
        assertEq(_wrappedM.totalNonEarningSupply(), 300_000000);
        assertEq(_wrappedM.totalSupply(), 600_000000);
        // assertEq(_wrappedM.accruedYieldOfEarningSupply(), 150_000000);
        assertEq(_wrappedM.excessOfM(), 249_999999); // TODO: This drop indicates that a claim of excess before this action will result in an underflow here.

        vm.prank(_dave);
        _wrappedM.transfer(_bob, 50_000000);

        // Assert Bob (Earner)
        assertEq(_wrappedM.balanceOf(_bob), 200_000000);
        assertEq(_wrappedM.accruedYieldOf(_bob), 0);
        ...
        // Assert Alice (Earner)
        assertEq(_wrappedM.balanceOf(_alice), 200_000000);
        assertEq(_wrappedM.accruedYieldOf(_alice), 66_666667);
        ...
        // Assert Globals
        assertEq(_wrappedM.totalEarningSupply(), 533_333332);
        assertEq(_wrappedM.totalNonEarningSupply(), 250_000000);
        assertEq(_wrappedM.totalSupply(), 650_000000);
        // assertEq(_wrappedM.accruedYieldOfEarningSupply(), 150_000000);
        assertEq(_wrappedM.excessOfM(), 416_666668);
        ...
        assertEq(_wrappedM.balanceOf(_alice), 266_666667);
        assertEq(_wrappedM.accruedYieldOf(_alice), 0);

        // Assert Globals
        assertEq(_wrappedM.totalEarningSupply(), 266_666664);
        assertEq(_wrappedM.totalNonEarningSupply(), 516_666668);
        assertEq(_wrappedM.totalSupply(), 716_666667);
        // assertEq(_wrappedM.accruedYieldOfEarningSupply(), 150_000000);
        assertEq(_wrappedM.excessOfM(), 416_666668);
        ...
        // Assert Globals
        assertEq(_wrappedM.totalEarningSupply(), 466_666664);
        assertEq(_wrappedM.totalNonEarningSupply(), 316_666668);
        assertEq(_wrappedM.totalSupply(), 716_666667);
        // assertEq(_wrappedM.accruedYieldOfEarningSupply(), 150_000000);
        assertEq(_wrappedM.excessOfM(), 416_666668);
        ...
        // Assert Globals
        assertEq(_wrappedM.totalEarningSupply(), 583_333330);
        assertEq(_wrappedM.totalNonEarningSupply(), 316_666668);
        assertEq(_wrappedM.totalSupply(), 716_666667);
        // assertEq(_wrappedM.accruedYieldOfEarningSupply(), 150_000000);
        ...
        // Assert Globals
        assertEq(_wrappedM.totalEarningSupply(), 583_333330);
        assertEq(_wrappedM.totalNonEarningSupply(), 50_000001);
        ...
        // Assert Globals
        assertEq(_wrappedM.totalEarningSupply(), 250_000000);
        assertEq(_wrappedM.totalNonEarningSupply(), 50_000001);
        assertEq(_wrappedM.totalSupply(), 250_000000);
        // assertEq(_wrappedM.accruedYieldOfEarningSupply(), 150_000000);
        ...
        // Assert Globals
        assertEq(_wrappedM.totalEarningSupply(), 0);
        assertEq(_wrappedM.totalNonEarningSupply(), 50_000001);
        assertEq(_wrappedM.totalSupply(), 50_000000);
        // assertEq(_wrappedM.accruedYieldOfEarningSupply(), 150_000000);
        ...
        // Assert Globals
        assertEq(_wrappedM.totalEarningSupply(), 0);
        assertEq(_wrappedM.totalNonEarningSupply(), 1);
        assertEq(_wrappedM.totalSupply(), 0);
        // assertEq(_wrappedM.accruedYieldOfEarningSupply(), 150_000000);
        assertEq(_wrappedM.excessOfM(), 600_000000);

        _wrappedM.claimExcess();

        _mToken.setBalanceOf(address(_wrappedM), 1);
